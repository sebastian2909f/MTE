...
#%%
df = pd.read_csv(r'C:\Users\GIIEE\Desktop\MTE_GRAPHS\DATOS\UBICACIONES_GENERACION.csv')
...
n41m_df = pd.read_csv(r'C:\Users\GIIEE\Desktop\MTE_GRAPHS\DATOS\DATOS_METEO.csv')
...
n1_ind = n4_pot_act_nor.columns.get_loc('NODO 5')
n2_ind = n4_pot_act_nor.columns.get_loc('NODO 6')
n3_ind = n4_pot_act_nor.columns.get_loc('NODO 9')
n4_ind = n4_pot_act_nor.columns.get_loc('NODO 10')
...
if ima == 1:
    fig1, axs = plt.subplots(4,1,figsize=(12,7), sharex= True)
    # axs[0].plot(n4_pot_act.iloc[:,'NODO92']) 
...
input_seq_length = 30*24*7
output_seq_length = 30*1
sliding_steps = 45
# sliding_steps = 30*1
...
for _, nodos_n in enumerate(nodos_N):
    for _, cell in enumerate(CELL):
        ...
        for epoch in tqdm(range(epocas)):
            ...
            with torch.no_grad():
                ...
                if val_loss < best_val_loss:
                    ...
                    epochs_without_improvement = 0
                    torch.save(model.state_dict(), r'C:\Users\GIIEE\Desktop\MTE_GRAPHS\MODELOS\METEREOLOGICOS\\'+out_txt+'.pth')
                    print('-------------> BEST MODEL')
                else:
        ...
        plt.savefig(r'C:\Users\GIIEE\Desktop\MTE_GRAPHS\MODELOS\METEREOLOGICOS\FIGURAS\Train_'+out_txt+'.png')
        ...
        path = r'C:\Users\GIIEE\Desktop\MTE_GRAPHS\MODELOS\METEREOLOGICOS\\'+out_txt+'.pth'
        print(path)
        ...
        num_nodes = 15  # Define la cantidad de nodos que tienes (en este caso, de 0 a 20)
        ...
        # Guardar la figura en un archivo (puedes especificar el formato, como PNG, PDF, SVG, etc.)
        plt.savefig(r'C:\Users\GIIEE\Desktop\MTE_GRAPHS\MODELOS\METEREOLOGICOS\FIGURAS\Res_'+out_txt+'.png')
        ...
        nombre_archivo = r"C:\Users\GIIEE\Desktop\MTE_GRAPHS\MODELOS\METEREOLOGICOS\METRICAS\DATA_"+mod+"_OUT"+str(output_seq_length)+"_IN"+str(input_seq_length)+".csv"
