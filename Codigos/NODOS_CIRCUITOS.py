...
#%%
df = pd.read_csv(r'C:\Users\GIIEE\Desktop\MTE_GRAPHS\DATOS\CIRCUITOS_UBICACION.csv')
...
#  print(ubi)
  #print(ubi[0])
  #print(ubi[1])
  G.add_node("Nodo"+str(i), latitud = ubi[4], longitud = ubi[5])
...
if ima == 1:
    # Definir un tamaño personalizado para la figura
    fig, ax = plt.subplots(figsize=(8, 4))  # Ajusta las dimensiones según tus necesidades
    pos = {node: (G.nodes[node]["latitud"], G.nodes[node]["longitud"]) for node in G.nodes}
    node_colors = [G.nodes[node]["color"] for node in G.nodes]
    # nx.draw(G, pos, with_labels=True, node_size=100, font_size=8, node_color=node_colors)
...
for i in df.iloc[:, 0]:
    ...
    if i in node_val:       
        ...
        # print('-------------------------')        
        # ubicaciones.append()
        ubicaciones['LATITUD'].append(a[4])
        ubicaciones['LONGITUD'].append(a[5])
    ind += 1
...
n41m_df = pd.read_csv(r'C:\Users\GIIEE\Desktop\MTE_GRAPHS\DATOS\datos_comb.csv', 
...
# SUBESTACION JAMONDINO-------------------------------------------
# n1_ind = n4_pot_act_nor.columns.get_loc('NODO 10')
# n2_ind = n4_pot_act_nor.columns.get_loc('NODO 11')
# n3_ind = n4_pot_act_nor.columns.get_loc('NODO 12')
# n4_ind = n4_pot_act_nor.columns.get_loc('NODO 13')

# SUBESTACION PASTO-----------------------------------------------
# n1_ind = n4_pot_act_nor.columns.get_loc('NODO 14')
# n2_ind = n4_pot_act_nor.columns.get_loc('NODO 15')
# n3_ind = n4_pot_act_nor.columns.get_loc('NODO 16')
# n4_ind = n4_pot_act_nor.columns.get_loc('NODO 17')
# n5_ind = n4_pot_act_nor.columns.get_loc('NODO 18')
# n6_ind = n4_pot_act_nor.columns.get_loc('NODO 19')

# SUBESTACION CATAMBUCO-----------------------------------------------
...
n6_ind = n4_pot_act_nor.columns.get_loc('NODO 5')
n7_ind = n4_pot_act_nor.columns.get_loc('NODO 6')
n8_ind = n4_pot_act_nor.columns.get_loc('NODO 7')
n9_ind = n4_pot_act_nor.columns.get_loc('NODO 8')
n10_ind = n4_pot_act_nor.columns.get_loc('NODO 9')
...
col_n6 = n4_pot_act_nor.columns[n6_ind]
col_n7 = n4_pot_act_nor.columns[n7_ind]
col_n8 = n4_pot_act_nor.columns[n8_ind]
col_n9 = n4_pot_act_nor.columns[n9_ind]
col_n10 = n4_pot_act_nor.columns[n10_ind]

# print(f"Indice de nodos objetivos: {col_n1}, {col_n2}, {col_n3}, {col_n4}")
# print(f"Indice de nodos objetivos: {col_n1}, {col_n2}, {col_n3}, {col_n4}, {col_n5}, {col_n6}")
print(f"Indice de nodos objetivos: {col_n1}, {col_n2}, {col_n3}, {col_n4}, {col_n5}, {col_n6}, {col_n7}, {col_n8}, {col_n9}, {col_n10}")
#%% FIGURA
...
input_seq_length = 60*24*3
output_seq_length = 60*1
# sliding_steps = 60*3
sliding_steps = 30
...
for _, nodos_n in enumerate(nodos_N):
    for _, cell in enumerate(CELL):
        ...
        for epoch in tqdm(range(epocas)):
            ...
            for times in range(len(feature_train_set)):
                ...
                if nodos_n == 4:        
                    ...
                    y_hat_p = y_hat[[n1_ind, n2_ind]]  # Predicciones para nodos específicos
                    y_train_set_p = y_train_set[times, [n1_ind, n2_ind]]  # Etiquetas reales
                
                elif nodos_n == 6:
                    y_hat_p = y_hat[[n1_ind, n2_ind, n3_ind, n4_ind, n5_ind, n6_ind]]  # Predicciones para nodos específicos
                    y_train_set_p = y_train_set[times, [n1_ind, n2_ind, n3_ind, n4_ind, n5_ind, n6_ind]]  # Etiquetas reales
                
                elif nodos_n == 7:
                    y_hat_p = y_hat[[n1_ind, n2_ind, n3_ind, n4_ind, n5_ind, n6_ind, n7_ind]]  # Predicciones para nodos específicos
                    y_train_set_p = y_train_set[times, [n1_ind, n2_ind, n3_ind, n4_ind, n5_ind, n6_ind, n7_ind]]  # Etiquetas reales
                    
                elif nodos_n == 8:
                    y_hat_p = y_hat[[n1_ind, n2_ind, n3_ind, n4_ind, n5_ind, n6_ind, n7_ind, n8_ind]]  # Predicciones para nodos específicos
                    y_train_set_p = y_train_set[times, [n1_ind, n2_ind, n3_ind, n4_ind, n5_ind, n6_ind, n7_ind, n8_ind]]  # Etiquetas reales
                
                elif nodos_n == 9:
                    y_hat_p = y_hat[[n1_ind, n2_ind, n3_ind, n4_ind, n5_ind, n6_ind, n7_ind, n8_ind, n9_ind]]  # Predicciones para nodos específicos
                    y_train_set_p = y_train_set[times, [n1_ind, n2_ind, n3_ind, n4_ind, n5_ind, n6_ind, n7_ind, n8_ind, n9_ind]]  # Etiquetas reales
                
                elif nodos_n == 10:
                    y_hat_p = y_hat[[n1_ind, n2_ind, n3_ind, n4_ind, n5_ind, n6_ind, n7_ind, n8_ind, n9_ind, n10_ind]]  # Predicciones para nodos específicos
                    y_train_set_p = y_train_set[times, [n1_ind, n2_ind, n3_ind, n4_ind, n5_ind, n6_ind, n7_ind, n8_ind, n9_ind, n10_ind]]  # Etiquetas reales
                            
                else: 
                    y_hat_p = y_hat[[n1_ind]]  # Predicciones para nodos específicos
                    y_train_set_p = y_train_set[times, [n1_ind]]  # Etiquetas reales
            ...
            with torch.no_grad():
                ...
                for val_time in range(len(feature_val_set)):
                    ...
                    if nodos_n == 4:        
                        ...
                        val_y_hat_p = val_y_hat[[n1_ind, n2_ind]]  # Predicciones para nodos específicos
                        y_val_set_p = y_val_set[val_time, [n1_ind, n2_ind]]  # Etiquetas reales
                        
                    elif nodos_n == 6:        
                        val_y_hat_p = val_y_hat[[n1_ind, n2_ind, n3_ind, n4_ind, n5_ind, n6_ind]]
                        y_val_set_p = y_val_set[val_time, [n1_ind, n2_ind, n3_ind, n4_ind, n5_ind, n6_ind]]
                        
                    elif nodos_n == 7:        
                        val_y_hat_p = val_y_hat[[n1_ind, n2_ind, n3_ind, n4_ind, n5_ind, n6_ind, n7_ind]]
                        y_val_set_p = y_val_set[val_time, [n1_ind, n2_ind, n3_ind, n4_ind, n5_ind, n6_ind, n7_ind]]
                        
                    elif nodos_n == 8:        
                        val_y_hat_p = val_y_hat[[n1_ind, n2_ind, n3_ind, n4_ind, n5_ind, n6_ind, n7_ind, n8_ind]]
                        y_val_set_p = y_val_set[val_time, [n1_ind, n2_ind, n3_ind, n4_ind, n5_ind, n6_ind, n7_ind, n8_ind]]
                        
                    elif nodos_n == 9:        
                        val_y_hat_p = val_y_hat[[n1_ind, n2_ind, n3_ind, n4_ind, n5_ind, n6_ind, n7_ind, n8_ind, n9_ind]]
                        y_val_set_p = y_val_set[val_time, [n1_ind, n2_ind, n3_ind, n4_ind, n5_ind, n6_ind, n7_ind, n8_ind, n9_ind]]
                        
                    elif nodos_n == 10:        
                        val_y_hat_p = val_y_hat[[n1_ind, n2_ind, n3_ind, n4_ind, n5_ind, n6_ind, n7_ind, n8_ind, n9_ind, n10_ind]]
                        y_val_set_p = y_val_set[val_time, [n1_ind, n2_ind, n3_ind, n4_ind, n5_ind, n6_ind, n7_ind, n8_ind, n9_ind, n10_ind]]
                    
                    else: 
                        val_y_hat_p = val_y_hat[[n1_ind]]  # Predicciones para nodos específicos
                        y_val_set_p = y_val_set[val_time, [n1_ind]]  # Etiquetas reales
                ...
                if val_loss < best_val_loss:
                    ...
                    epochs_without_improvement = 0
                    torch.save(model.state_dict(), r'C:\Users\GIIEE\Desktop\MTE_GRAPHS\MODELOS\CIRCUITOS\\'+out_txt+'.pth')
                    print('-------------> BEST MODEL')
                else:
        ...
        plt.savefig(r'C:\Users\GIIEE\Desktop\MTE_GRAPHS\MODELOS\CIRCUITOS\FIGURAS\Train_'+out_txt+'.png')
        ...
        path = r'C:\Users\GIIEE\Desktop\MTE_GRAPHS\MODELOS\CIRCUITOS\\'+out_txt+'.pth'
        print(path)
        ...
        # Convertir el tensor a un array numpy
        y_out_test = y_test_set.numpy()
        
        # Recortar el array en la dimensión deseada
        y_out_test_cut = y_out_test[:, :, 0:sliding_steps]
        
        # Inicializar una lista de arrays vacíos para cada nodo
        num_nodes = 20  # Define la cantidad de nodos que tienes (en este caso, de 0 a 20)
        node_data_test = [np.array([]) for _ in range(num_nodes)]
        
        # Iterar sobre los datos recortados y cada nodo para rellenar los arrays
        for data in y_out_test_cut:
            for node_idx in range(num_nodes):
                node_data_test[node_idx] = np.append(node_data_test[node_idx], data[node_idx])
        
        # Ahora cada elemento en node_data es un array de las series de tiempo correspondientes
        # por ejemplo, node_data[0] tiene los datos del nodo 0, node_data[1] del nodo 1, etc.
        ...
        # Inicializar una lista vacía para almacenar los datos de cada nodo        
        node_data_pre = [np.array([]) for _ in range(num_nodes)]
        
        # Iterar sobre los datos de salida para cada nodo
        for data in y_out_pre:
            for node_idx in range(num_nodes):
                node_data_pre[node_idx] = np.append(node_data_pre[node_idx], data[node_idx])
        
        # Ahora cada elemento en node_data es un array con los datos correspondientes
        # node_data[0] tiene los datos de node_0, node_data[1] los de node_1, etc.
        ...
        # Calcular métricas para cada nodo (asumiendo que tienes 20 nodos)
        for i in range(20):
            y_real = node_data_pre[i]
            y_pred = node_data_test[i]
        ...
        #%%
        # Número de datos
        n = len(node_data_pre[0])  # Suponiendo que 'node_0_test' es tu array con n datos
        ...
        # Convertir node_data_test a un array de NumPy si no lo es
        node_data_test = np.array(node_data_test)
        node_data_pre = np.array(node_data_pre)
        ...
        axs[0].plot(fechas, node_data_test[n1_ind, :])
        axs[0].plot(fechas,node_data_pre[n1_ind,:],'--')
        axs[1].plot(fechas, node_data_test[n2_ind, :])
        axs[1].plot(fechas,node_data_pre[n2_ind,:],'--')
        axs[2].plot(fechas, node_data_test[n3_ind, :])
        axs[2].plot(fechas,node_data_pre[n3_ind,:],'--')
        axs[3].plot(fechas, node_data_test[n4_ind, :])
        axs[3].plot(fechas,node_data_pre[n4_ind,:],'--')
        
        axs[0].set_title('NODE 0 MSE = {:.5f} - MAE = {:.5f} - R² = {:.5f}'.format(mse_list[n1_ind],mae_list[n1_ind],r2_list[n1_ind]))
        axs[1].set_title('NODE 1 MSE = {:.5f} - MAE = {:.5f} - R² = {:.5f}'.format(mse_list[n2_ind],mae_list[n2_ind],r2_list[n2_ind]))
        axs[2].set_title('NODE 2 MSE = {:.5f} - MAE = {:.5f} - R² = {:.5f}'.format(mse_list[n3_ind],mae_list[n3_ind],r2_list[n3_ind]))
        axs[3].set_title('NODE 3 MSE = {:.5f} - MAE = {:.5f} - R² = {:.5f}'.format(mse_list[n4_ind],mae_list[n4_ind],r2_list[n4_ind]))
        ...
        # Guardar la figura en un archivo (puedes especificar el formato, como PNG, PDF, SVG, etc.)
        plt.savefig(r'C:\Users\GIIEE\Desktop\MTE_GRAPHS\MODELOS\CIRCUITOS\FIGURAS\Res_'+out_txt+'.png')
        ...
        # Asegurarse de que datos_modelo tenga las claves "NODE 0", "NODE 1", ..., "NODE 19"
        for i in range(20):
            node_key = f"NODE {i}"
            datos_modelo[node_key].append(np.mean(r2_list[i]))
        ...
        nombre_archivo = r"C:\Users\GIIEE\Desktop\MTE_GRAPHS\MODELOS\CIRCUITOS\METRICAS\DATA_"+mod+"_OUT"+str(output_seq_length)+"_IN"+str(input_seq_length)+".csv"
